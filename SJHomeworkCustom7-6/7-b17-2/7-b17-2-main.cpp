...
int main()
{
	...
	cout << endl;
	cout << "group_add(fp, \"China\"); (第二次)    实际结果：";
	cout << group_add(fp, "China") << endl;
	cout << "文件内容：" << endl;
	print(fp);
	...
	cout << endl;
	cout << "group_add(fp, \"British\");    实际结果：";
	cout << group_add(fp, "British") << endl;
	print(fp);
	cout << "group_add(fp, \"America\");    实际结果：";
	cout << group_add(fp, "America") << endl;
	cout << "group_add(fp, \"Russia\");    实际结果：";
	...
	cout << "目标项是否还存在，  实际结果：" << item_get_value(fp, "America", "首都", space, TYPE_STRING) << endl;

	cout << "item_del(fp, \"America\", \"国际区号\");  \n  实际结果：";
	cout << item_del(fp, "America", "国际区号") << endl;
	cout << "目标项是否还存在，  实际结果：" << item_get_value(fp, "America", "国际区号", &code, TYPE_INT) << endl << endl;
	...
	cout << "目标组是否还存在，  实际结果：" << item_get_value(fp, "China", "首都", space, TYPE_STRING) << endl;
