...
const int colorList[] = { COLOR_HBLACK,COLOR_HWHITE,COLOR_HRED,COLOR_RED,COLOR_HYELLOW,COLOR_HGREEN,COLOR_HCYAN,COLOR_BLUE,COLOR_HPINK, COLOR_HWHITE };
...
void mouseActions(int startX, int startY, int promptX, int promptY, int quitX, int quitY, int * position, int w, int h);
